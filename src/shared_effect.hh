...
auto
make_sharedeffect_eta(const Eigen::MatrixBase<xDerived> &xx,
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_sharedeffect_eta(const Eigen::SparseMatrixBase<xDerived> &xx,
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_sharedeffect_eta_ptr(const Eigen::MatrixBase<xDerived> &xx,
                          const Eigen::MatrixBase<yDerived> &yy,
                          Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_sharedeffect_eta_ptr(const Eigen::SparseMatrixBase<xDerived> &xx,
                          const Eigen::SparseMatrixBase<yDerived> &yy,
                          Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
template <typename Param, typename Scalar>
struct get_transpose_sharedeffect_type<Param,
                                       Scalar,
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_transpose_sharedeffect_eta(const Eigen::MatrixBase<xDerived> &xx,
                                const Eigen::MatrixBase<yDerived> &yy,
                                Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_transpose_sharedeffect_eta(const Eigen::SparseMatrixBase<xDerived> &xx,
                                const Eigen::SparseMatrixBase<yDerived> &yy,
                                Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_transpose_sharedeffect_eta_ptr(const Eigen::MatrixBase<xDerived> &xx,
                                    const Eigen::MatrixBase<yDerived> &yy,
                                    Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
template <typename xDerived, typename yDerived, typename Param>
auto
make_transpose_sharedeffect_eta_ptr(const Eigen::SparseMatrixBase<xDerived> &xx,
                                    const Eigen::SparseMatrixBase<yDerived> &yy,
                                    Param &theta)
{
    using Scalar = typename yDerived::Scalar;
...
struct sharedeffect_t {
    ...
    explicit sharedeffect_t(const ReprMatrix &xx,
                            const ReprMatrix &yy,
                            Param &theta)
        : n(xx.rows())
        , p(xx.cols())
...
struct transpose_sharedeffect_t {
    ...
    explicit transpose_sharedeffect_t(const ReprMatrix &xx,
                                      const ReprMatrix &yy,
                                      Param &theta)
        : n(yy.rows())
        , p(xx.rows())
    ...
    {
        update_mean(Eta,
                    onesN * mean_param(Theta) * X); // [n x 1] [1 x p] [p x m]
        update_var(Eta,
                   onesN * var_param(Theta) * Xsq); // [n x 1] [1 x p] [p x m]
    }
