...
void
impl_initialize_param(Parameter &P, const tag_param_col_spike_slab)
{
...
template <typename Parameter>
void
impl_resolve_param(Parameter &P, const tag_param_col_spike_slab)
{
...
template <typename Parameter>
void
impl_resolve_hyperparam(Parameter &P, const tag_param_col_spike_slab)
{
...
template <typename Parameter>
void
impl_check_nan_param(Parameter &P, const tag_param_col_spike_slab)
{
...
template <typename Parameter>
const auto &
impl_mean_param(Parameter &P, const tag_param_col_spike_slab)
{
    return P.theta;
}
...
template <typename Parameter>
auto
impl_log_odds_param(Parameter &P, const tag_param_col_spike_slab)
{
...
template <typename Parameter>
const auto &
impl_var_param(Parameter &P, const tag_param_col_spike_slab)
{
    return P.theta_var;
}
